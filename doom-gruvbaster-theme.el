...
(defgroup doom-gruvbaster-theme nil
  "Options for doom-gruvbaster."
  :group 'doom-themes)

;;
;;; Theme definition

(def-doom-theme doom-gruvbaster
  "Minimal dark theme with pastel 'retro groove' colors."

  ;; name        gui       256       16
  ((bg         '("#282828" "#282828" nil)) ; bg0
   (bg-alt     '("#1d2021" "#1e1e1e" nil)) ; bg_h
   ...
   (selection      bg-alt2)
   (builtin        fg)
   (comments       (doom-lighten yellow 0.2))
   (doc-comments   yellow)
   (constants      violet)
   (functions      magenta)
   (keywords       fg)
  ...
  ((button :foreground cyan :underline t :weight 'bold)
   ...
   ;;;; rainbow-delimiters
   (rainbow-delimiters-depth-1-face :foreground (doom-darken fg 0.30))
   (rainbow-delimiters-depth-2-face :foreground (doom-darken fg 0.30))
   (rainbow-delimiters-depth-3-face :foreground (doom-darken fg 0.30))
   (rainbow-delimiters-depth-4-face :foreground (doom-darken fg 0.30))
   (rainbow-delimiters-depth-5-face :foreground (doom-darken fg 0.30))
   (rainbow-delimiters-depth-6-face :foreground (doom-darken fg 0.30))
   (rainbow-delimiters-depth-7-face :foreground (doom-darken fg 0.30))
   (rainbow-delimiters-depth-8-face :foreground (doom-darken fg 0.30))
   (rainbow-delimiters-depth-9-face :foreground (doom-darken fg 0.30))
   ;;;; show-paren <built-in>
   ((show-paren-match &override) :foreground red :background bg-alt :weight 'ultra-bold :underline t)
...
(provide 'doom-gruvbaster-theme)


;;; doom-gruvbaster-theme.el ends here
